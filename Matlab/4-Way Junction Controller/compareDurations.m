...
figure
boxplot([nSum oSum],{'Evolved' 'Original'},'orientation','horizontal')
title('Distribution of Car Durations for Round-robin Controller against Evolved EpiNet Controller');
