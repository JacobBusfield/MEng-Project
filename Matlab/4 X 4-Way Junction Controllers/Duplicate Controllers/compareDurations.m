...
figure
boxplot([nSum oSum],{'Duplicate' 'Round-Robin'},'orientation','horizontal')
title({'Distribution of Car Durations for Round-robin vs';'Duplicate EpiNet Controllers on Traffic Network'});
