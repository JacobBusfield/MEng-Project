========================================================================
                    SIMULATION README: DUPLICATE FOLDER
========================================================================

This folder contains the result files from evolving a duplicate
controllers on the traffic network (4WJX4).
...
Results from running each on the 4WJX4 using the evolved duplicate epiNet 
