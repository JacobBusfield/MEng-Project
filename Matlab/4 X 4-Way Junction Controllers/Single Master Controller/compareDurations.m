...
figure
boxplot([nSum oSum],{'Single' 'Round Robin'},'orientation','horizontal')
title({'Distribution of Car Durations for Round-robin vs';'Single EpiNet Controller on Traffic Network'});
