...
figure
boxplot([nSum oSum],{'Seperate' 'Round Robin'},'orientation','horizontal')
title({'Distribution of Car Durations for Round-robin vs';'Seperate EpiNet Controllers on Traffic Network'});
